...
When an `ARMAModel` is constructed by any of these methods, the other two
representations are also computed and stored.

For fast mutliplies and solves of either the noise model covariance matrix or
its Cholesky factor, see `ARMASolver`."""
